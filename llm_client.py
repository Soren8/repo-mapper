...
def generate_summary(file_content, llm_endpoint, api_key=None, llm_model="deepseek/deepseek-chat", yes=False):
    ...
    prompt = f"Analyze the following file content and determine if it is a core code file. If it is a core code file, provide a Markdown summary with sections: Key Functions, Complete Function List, Dependencies, and Referenced By. If it is not a core code file, provide a very concise summary (1-2 sentences) describing its purpose and relevance. **Do not include any preamble or explanation in your response.**\n\nFile Content:\n\n{file_content}"
